    ...
    <div className="flex flex-col h-screen gap-2">
      ...
      <main className="mx-3">
        <div className="flex justify-between p-2 my-1 ">
          ...
          <button onClick={() => setModalOpen(true)} className="bg-blue-500 hover:bg-blue-400 rounded-full py-2 px-4 items-center text-white">Add User</button>
        </div>
      ...
      </main>
      {
        isModalOpen && (
          <UserModal onClose={() =>
            setModalOpen(false)} onSubmit={handleAddUser}/>
        )
      }
    </div>
  )
